...
<body>
    ...
    <div class="btn_show">
        <button class="toggle-button" id="trocarNomeCardapio" onclick="toggleItens()">Mostrar Itens do Cardápio</button>
    </div>
    ...
    <div class="btn_show">
        <button class="toggle-button" id="trocarNomePromocao" onclick="togglePromocoes()">Mostrar Itens em Promoção</button>
    </div>
    ...
    <script>
        ...
        function toggleItens() {
            ...
            var botao = document.getElementById("trocarNomeCardapio");
            if (botao.innerHTML === "Mostrar Itens do Cardápio") {
                botao.innerHTML = "Esconder Itens do Cardápio";
            } else {
                botao.innerHTML = "Mostrar Itens do Cardápio";
            }
        }
        ...
        function togglePromocoes() {
            ...
            var botao = document.getElementById("trocarNomePromocao");
            if (botao.innerHTML === "Mostrar Itens em Promoção") {
                botao.innerHTML = "Esconder Itens em Promoção";
            } else {
                botao.innerHTML = "Mostrar Itens em Promoção";
            }
        }
