...
<head>
  ...
  <style>
    ...
    .excluir-link {
      margin-top: 10px; /* Espaçamento entre o arquivo e o botão de excluir */
      align-self: flex-start; /* Alinhar o botão à esquerda, se desejado */
    }
    
    .files-section {
      display: none; /* Inicialmente oculto */
      margin-left: 20px; /* Indentação para a seção de arquivos */
    }

    .toggle-button {
      cursor: pointer;
      color: #f0f0f0; /* cor de banco */
      text-decoration: none; /* remove o sublinhado */
      text-align: center; /* centraliza o texto */
      display: block; /* faz o link se comportar como um bloco */
      padding: 10px; /* adiciona algum preenchimento */
      transition: background-color 0.3s ease, transform 0.3s ease; /* animação de hover */
    }
...
<body>
  <header class="barra_superior">
    <nav class="centralizacao_esq">
      <a href="/pages/menu.html" class="voltar">Voltar</a>
    </nav>
  ...
  <main>
    <form id="arquivos-form">
      <section>
        ...
        <div>
          <div class="toggle-button" onclick="toggleSection('imagens')">Imagens</div>
        ...
        <div>
          <div class="toggle-button" onclick="toggleSection('videos')">Vídeos</div>
        ...
        <div>
          <div class="toggle-button" onclick="toggleSection('textos')">Textos</div>
        ...
        <div>
        <div class="toggle-button" onclick="toggleSection('playlists')">Playlists</div>
